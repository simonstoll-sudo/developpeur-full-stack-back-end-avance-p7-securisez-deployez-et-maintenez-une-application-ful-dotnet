...
On a aussi un doute sur le nombre d'appels faits à la base au moment de l'affichage du tableau de bord. Un ancien du projet parlait d'un problème classique d'Entity Framework où chaque ligne déclenche une requête séparée, mais ça n'a jamais été confirmé formellement.
